...
def install_xray_core():
    ...
    os.system('bash -c "$(curl -L https://github.com/XTLS/Xray-install/raw/main/install-release.sh)" @ install --version 25.8.3')
    os.system("systemctl disable --now xray snapd snapd.socket")

def install_pip():
    change_to_normal_dns()
    os.system('apt-get update')
    os.system("apt install python3 build-essential libssl-dev libffi-dev libpq-dev python3-dev -y")
